...
const Profile = () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        const canViewContent =
          ...
          profileData.follow_status === "accepted";
        if (canViewContent) {
          fetchUserPosts();
  ...
  const handleDeclineRequest = async (followerID) => {
    try {
      const response = await api.post(
        `/users/follow-requests/${followerID}/decline`,
      );
      if (response.success) {
        setFollowRequests((prev) =>
          prev.filter((r) => r.user_id !== followerID),
  ...
  const handleDeleteAlbum = async (e, albumID) => {
    ...
    if (
      !window.confirm(
        "Are you sure you want to delete this album? Your posts won't be deleted, but the album itself will be removed.",
      )
    )
      return;
    try {
  ...
  const handleFollowToggle = async () => {
    ...
    const isCurrentlyFollowedOrPending =
  ...
  if (!profile) {
    return (
      ...
      >
        <ShieldAlert
          size={48}
          style={{ color: "hsl(var(--danger))", marginBottom: "16px" }}
        />
    ...
    <div className="profile-container fade-in">
      ...
      profile.follow_status !== "accepted" ? (
        <div className="private-profile-lock glass fade-in">
          <Lock
            size={40}
            style={{ color: "hsl(var(--text-muted))", marginBottom: "12px" }}
          />
          ...
          {activeTab === "posts" &&
            (loadingPosts ? (
              ...
              <div className="empty-posts glass">
                ...
                <p>
                  {isOwnProfile
                    ? "Share your first spectacular image or video!"
            ...
            <div className="albums-container fade-in">
              {isOwnProfile && (
                ...
                >
                  ...
                  >
                    <Plus size={16} style={{ marginRight: "6px" }} /> Create New
                    Album
                  </button>
                </div>
              )}
                      ...
                      >
                        ...
                        <div className="album-info-overlay">
                          ...
                          <div className="album-actions-row">
                            <span>
                              {album.posts ? album.posts.length : 0} posts
                            </span>
                            <span
                              style={{
        ...
        <div className="modal-overlay" onClick={() => setEditModalOpen(false)}>
          ...
          >
            ...
            >
              ...
              >
                <Edit3 style={{ color: "hsl(var(--primary))" }} /> Edit Profile
                Info
              </h3>
              <button
              ...
              <div className="switch-container">
                <div className="switch-label-wrap">
                  ...
                  <span className="switch-label-desc">
                    Only approved followers can see your posts and albums.
                  </span>
                </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Sparkles style={{ color: "hsl(var(--primary))" }} /> Create New
                Album
              </h3>
              <button
                className="drawer-close"
          ...
          >
            ...
            >
              <div>
                ...
                >
                  <Sparkles style={{ color: "hsl(var(--primary))" }} />{" "}
                  {selectedAlbum.title}
                </h3>
